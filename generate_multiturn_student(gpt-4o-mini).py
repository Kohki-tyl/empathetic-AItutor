    ...
    "json_schema": {
        ...
        "schema": {
            ...
            "properties": {
                "emotion": {
                    "type": "string",
                    "enum": ["Confident", "Joy", "Encouraging", "Empathetic", "Apprehensive", "Anxious"]
                    },
                "error_detected": {"type": "string"},
                "roadmap_breakdown": {"type": "string"},
                "next_step_plan": {"type": "string"},
                "teacher_utterance": {"type": "string"},
                "is_completed": {"type": "boolean"}
            },
            "required": ["emotion", "error_detected", "roadmap_breakdown", "next_step_plan", "teacher_utterance", "is_completed"],
...
def generate_dialogue(problem: str, profile_dict: dict, max_turns: int = 15) -> dict:
    ...
    for current_turn in range(max_turns):
        ...
        try:
            ...
            emotion = teacher_data.get("emotion", "")
            error_val = teacher_data.get("error_detected", "")
